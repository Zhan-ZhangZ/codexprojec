...
- **只手工维护一份内容**：在 **src/ui-ux-pro-max/** 修改 data、scripts 和 templates，再用 `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/scripts/sync-assets.mjs` 将它们复制到 `cli/assets/`，并将 data、scripts 复制到本地 Claude Skill 目录。
