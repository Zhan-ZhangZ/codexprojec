...
Release notes and `CHANGELOG.md` are generated from Conventional Commit messages. Version numbers are synchronized across `skill.json`, `.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package.json`, and `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package-lock.json` during release preparation.
