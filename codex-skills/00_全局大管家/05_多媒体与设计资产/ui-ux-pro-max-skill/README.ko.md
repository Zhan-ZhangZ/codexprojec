...
릴리스 노트와 `CHANGELOG.md`는 Conventional Commit 메시지에서 생성됩니다. 릴리스 준비 중 `skill.json`, `.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package.json`, `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package-lock.json`의 버전 번호가 동기화됩니다.
