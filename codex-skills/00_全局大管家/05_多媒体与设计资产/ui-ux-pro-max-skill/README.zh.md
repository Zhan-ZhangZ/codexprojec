...
发布说明和 `CHANGELOG.md` 根据约定式提交信息生成。在发布准备期间，版本号会在 `skill.json`、`.claude-plugin/plugin.json`、`.claude-plugin/marketplace.json`、`https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package.json` 和 `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package-lock.json` 之间同步。
