...
Release notes dan `CHANGELOG.md` dibuat dari pesan Conventional Commit. Nomor versi disinkronkan di `skill.json`, `.claude-plugin/plugin.json`, `.claude-plugin/marketplace.json`, `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package.json`, dan `https://github.com/nextlevelbuilder/ui-ux-pro-max-skill/blob/58c220f/cli/package-lock.json` selama persiapan rilis.
