---
name: ppt-master
description: AI 驱动的多格式 SVG 内容生成系统。通过多角色协作，将源文档（PDF/DOCX/URL/Markdown）转换为高质量的 SVG 页面，并最终导出为 PPTX 格式。当用户要求“创建PPT”、“生成PPT”、“制作演示文稿”或提及“ppt-master”时触发此技能。Leading Words: 多格式内容生成, SVG高质量排版, 自动生成PPTX, 多角色协作PPT
---
