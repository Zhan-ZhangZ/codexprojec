...
- **Pinned: `@tailwindcss/browser@4.2.4`** (source of truth: `https://github.com/heygen-com/hyperframes/blob/v0.8.25/packages/cli/src/commands/init.ts` `TAILWIND_BROWSER_VERSION`).
