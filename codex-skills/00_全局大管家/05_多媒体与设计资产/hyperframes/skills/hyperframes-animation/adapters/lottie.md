...
- HyperFrames adapter source: `https://github.com/heygen-com/hyperframes/blob/v0.8.25/packages/core/src/runtime/adapters/lottie.ts`.
- Duration auto-inference: `https://github.com/heygen-com/hyperframes/blob/v0.8.25/packages/core/src/runtime/init.ts` (`resolveAdapterDurationFloorSeconds`), `getInferredDurationSeconds` in the adapter above.
