...
- `https://github.com/heygen-com/hyperframes/blob/v0.8.25/registry/examples/airbnb-deck/index.html` + `demo.html` — full pattern set (Three.js, fragments, SFX, branch slide)
- `https://github.com/heygen-com/hyperframes/blob/v0.8.25/registry/examples/startup-pitch/index.html` — minimal version (no 3D), good starting point
