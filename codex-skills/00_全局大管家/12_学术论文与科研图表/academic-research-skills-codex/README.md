...
**Using Pi?** Run `pi install git:github.com/Imbad0202/academic-research-skills` to install the upstream community-maintained wrapper (tracks the original ARS content).
...
**[eltociear](https://github.com/eltociear)** (Ikko Eltociear Ashimine) — Contributor. Translated the Japanese README (`README.ja-JP.md`, available upstream) ([PR #161](https://github.com/Imbad0202/academic-research-skills/pull/161)).
...
**[devCharlotte](https://github.com/devCharlotte)** — Contributor. Translated the Korean README (`README.ko-KR.md`, available upstream) ([PR #469](https://github.com/Imbad0202/academic-research-skills/pull/469)).
