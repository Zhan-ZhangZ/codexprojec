...
**使用 Pi？** 运行 `pi install git:github.com/Imbad0202/academic-research-skills` 安装上游社区维护的 wrapper（以原始 ARS 内容为准）。
...
**[eltociear](https://github.com/eltociear)**（Ikko Eltociear Ashimine）— 贡献者。翻译了日文版 README（`README.ja-JP.md`，见上游仓库）（[PR #161](https://github.com/Imbad0202/academic-research-skills/pull/161)）。
