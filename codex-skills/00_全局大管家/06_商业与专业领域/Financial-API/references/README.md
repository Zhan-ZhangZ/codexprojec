...
[![Python](https://img.shields.io/badge/Python-3.11%2B-3776ab)](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/pyproject.toml)
[![Node.js](https://img.shields.io/badge/Node.js-22.12%2B-339933)](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/hithink-finance-cli/package.json)
...
优先安装 [`hithink-finance` Skill](hithink-finance/SKILL.md)。Agent 会识别当前环境和任务，在 API、MCP、CLI 与 Python SDK 之间自动选择合适的能力。
...
API、MCP、CLI 和 Python 远端取数共用同一个 API Key。统一推荐保存为用户级环境变量 `HITHINK_FINANCE_API_KEY`；`hithink-finance` Skill 也能读取用户级 `credentials.env`，具体路径与各平台配置命令见 [Skill 的 CLI 安装说明](hithink-finance/references/cli/setup.md)。
...
如无法使用以上安装方式，也可以把完整的 [`skills/hithink-finance/`](hithink-finance/SKILL.md) 目录复制到 Agent 文档声明的 Skills 发现目录。
...
完整说明见 [`https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/hithink-finance-cli/README.md`](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/hithink-finance-cli/README.md)。
...
```bash
python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/fuyao/scripts/fuyao.py tickers-search --q "贵州茅台"
python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/fuyao/scripts/fuyao.py prices-snapshot --thscodes 600519.SH
```
...
- [Python README](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/README.md)
- [toolkit 路由](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/README.md)
- [Python 可执行示例](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/examples/README.md)
...
```bash
python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/bootstrap.py
```
...
完整说明见 [`https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/marketdb/README.md`](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/marketdb/README.md)。
...
2. [`hithink-finance/SKILL.md`](hithink-finance/SKILL.md)
3. 与实际接入方式对应的一个详细入口
...
[`python/examples/`](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/examples/README.md) 提供 SDK、marketdb 和远端数据组合示例。

### 金融看板灵感

[`examples/inspirations/`](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/examples/inspirations/README.md) 提供可以复制使用的 Prompt、预览图和静态 HTML。

### 默认示例：单股行情与趋势速览

[![单股行情与趋势速览](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/examples/inspirations/01-stock-overview/preview.jpg)](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/examples/inspirations/01-stock-overview/README.md)
...
- [完整说明与 Prompt](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/examples/inspirations/01-stock-overview/README.md)
- [直接打开静态 HTML](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/examples/inspirations/01-stock-overview/example.html)
...
- `hithink-finance/references/api.md`、`references/api/`、`references/mcp.md` 与 `references/mcp/` 由 `python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/scripts/sync_skill_contracts.py` 生成，确保 Skill 独立发布时仍然自包含。
...
```bash
python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/scripts/sync_skill_contracts.py --check
...
- [CLI README](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/hithink-finance-cli/README.md)
- [Python README](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/README.md)
- [Python toolkit](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/README.md)
- [marketdb 文档](https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/marketdb/README.md)
- [Agent Skill](hithink-finance/SKILL.md)
