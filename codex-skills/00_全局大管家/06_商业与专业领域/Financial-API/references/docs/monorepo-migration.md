...
| `python bootstrap.py` | `python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/bootstrap.py` |
| `python toolkit/fuyao/scripts/fuyao.py ...` | `python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/fuyao/scripts/fuyao.py ...` |
| `python examples/01_quickstart.py` | `python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/examples/01_quickstart.py` |
| `python -m pytest tests/` | `python -m pytest python/tests/` |
| `toolkit/README.md` | `https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/README.md` |
| `toolkit/marketdb/README.md` | `https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/marketdb/README.md` |
| `toolkit/fuyao/README.md` | `https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/fuyao/README.md` |
| `examples/inspirations/scripts/build_index.py` | `https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/tools/inspirations/build_index.py` |
...
1. 根 `AGENTS.md`；
2. `../hithink-finance/SKILL.md`；
3. `https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/README.md`；
4. 具体任务对应的 `https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/marketdb/README.md` 或 `https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/fuyao/README.md`。
...
```powershell
python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/bootstrap.py --help
python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/toolkit/fuyao/scripts/fuyao.py --help
python https://github.com/HiThink-Tech/Financial-API/blob/v0.1.7/python/tools/inspirations/build_index.py --check
