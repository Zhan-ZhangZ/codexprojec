...
**Files:**
- Create: [`trading.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/trading/trading.ts)
- Test: [`trading.test.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/tests/unit/api/trading.test.ts)

**Step 1: Write the failing test**

```typescript
// https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/tests/unit/api/trading.test.ts
...
Run: `npx vitest run https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/tests/unit/api/trading.test.ts`
Expected: FAIL — module not found

**Step 3: Write minimal implementation**

```typescript
// https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/trading/trading.ts
import type { TradingApiClient } from '@/api/client-trading.js';
...
```bash
git add https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/trading/trading.ts https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/tests/unit/api/trading.test.ts
...
**Files:**
- Modify: [`index.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/index.ts)
...
```bash
git add https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/index.ts
...
- Modify: [`index.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/index.ts)
...
In [`index.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/index.ts), add import:
```typescript
...
```bash
git add src/tools/definitions/index.ts https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/index.ts
