...
- [`trading.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/trading/trading.ts) — `TradingApi` class following existing API module patterns
- `src/tools/definitions/trading.ts` — MCP tool definitions with Zod input schemas

### Modified Files

- [`index.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/index.ts) — Register `TradingApi` in `EbaySellerApi`
- `src/tools/definitions/index.ts` — Export trading tools
- [`index.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/index.ts) — Add tool execution cases
