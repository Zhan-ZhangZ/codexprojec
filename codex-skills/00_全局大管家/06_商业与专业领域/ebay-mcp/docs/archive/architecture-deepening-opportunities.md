...
- [`registry.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/registry.ts)
- `src/tools/handlers.ts`
- [`contracts.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/contracts.ts)
- [`runtime.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/mcp/runtime.ts)
- [`request.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/shared/request.ts)
...
Move tool handlers next to their category definitions, so each eBay seller category Module owns its MCP definition and execution mapping. Keep [`registry.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/registry.ts) as the single registry seam that assembles entries and validates uniqueness, missing handlers, and orphan handlers.
...
- [`inventory.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/listing-management/inventory.ts)
- [`metadata.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/api/listing-metadata/metadata.ts)
...
Keep `src/server-http.ts` as a thin entrypoint and move HTTP session/auth/runtime wiring into a transport Module. Let [`runtime.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/mcp/runtime.ts) remain responsible only for MCP server construction and tool registration.
...
- `src/auth/credential-session.ts`
- [`oauth.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/auth/oauth.ts)
- `src/tools/handlers.ts`
- [`setup.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/scripts/setup.ts)
...
- [`contracts.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/contracts.ts)
- `src/tools/definitions/*.ts`
- [`schemas.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/schemas.ts)
- `src/schemas/**`
- `src/utils/**`
- `src/types/**/*.ts`
...
[`contracts.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/contracts.ts) validates presence, but schema ownership is still spread across definition files, broad tool schemas, category schemas, utility validators, and generated OpenAPI types. Handlers compensate with many `as string`, `as number`, and `as Record<string, unknown>` casts.
