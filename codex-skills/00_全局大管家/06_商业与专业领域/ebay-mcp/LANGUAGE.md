...
| **registry** | [`registry.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/tools/registry.ts) — assembles all `ToolEntry`s from `categories/` and exposes `executeTool`. | "router" (that's the CLI sense) |
