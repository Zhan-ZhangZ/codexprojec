...
<p align="center">
  <strong>eBay MCP 服务器 — 让 Claude、Cursor 以及任意 AI 助手完全访问 eBay 的 Sell API。299 个工具覆盖库存、订单、营销与分析，使用你自己的密钥在本地运行。</strong>
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/tools-299-8957e5?logo=ebay&logoColor=white" alt="299 个 eBay API 工具" />
...
**eBay MCP** 是一个本地的 [Model Context Protocol](https://modelcontextprotocol.io) 服务器，可将 AI 助手 —Claude Desktop、Claude Code、Cursor、Cline、Windsurf、Zed、Continue.dev、Roo Code 和 Amazon Q— 直接连接到 **eBay 的 Sell API**。它提供 **299 个工具**，覆盖 **eBay Sell API 的 100% 范围**（270 个唯一端点），涵盖库存管理、订单履行、推广刊登营销、分析和开发者工具。一切都在你的机器上通过 STDIO 或本地 HTTP 运行 — **没有云端中继**，你的 eBay 凭据永远不会离开你的电脑。
...
- **299 个 eBay API 工具** — 100% 覆盖 eBay Sell API，涵盖库存、订单、营销、分析、元数据、分类法和开发者工具。
...
| API 覆盖 | 299 个工具覆盖 100% Sell API，开箱即用 | 你需根据文档构建每个请求 |
...
**299 个工具**，100% Sell API 覆盖，按类别组织。每个链接都指向 [`src/tools/categories`](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categories) 中的工具定义及其处理程序：

| 类别 | 你可以做什么 |
| --- | --- |
| [Connector](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesconnector.ts) | 面向 eBay MCP 目录的 ChatGPT 连接器 search/fetch 工具 |
| [Account](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesaccount.ts) | 业务、履行、付款和退货政策；计划；订阅；销售税 |
| [Inventory](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesinventory.ts) | 库存商品、报价、地点、商品分组、批量操作、SKU/地点映射 |
| [Fulfillment](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesfulfillment.ts) | 订单、配送、退款、纠纷、付款纠纷证据 |
| [Marketing](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesmarketing.ts) | 推广刊登广告活动、广告、促销、出价、批量操作 |
| [Analytics](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesanalytics.ts) | 流量报告、卖家标准、客户服务指标 |
| [Communication](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriescommunication.ts) | 买卖双方消息、议价、通知、评价 |
| [Metadata](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesmetadata.ts) | 退货政策、销售税辖区、汽车兼容性 |
| [Taxonomy](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriestaxonomy.ts) | 类目树、商品属性、商品成色 |
| [Browse](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesbrowse.ts) | 已售/已完成 listing 搜索（Finding API）用于比价 |
| [Other](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesother.ts) | Identity、VeRO、翻译与国际物流支持 API（Compliance 工具会报告 eBay 于 2026-03-30 的下线） |
| [Trading（旧版 XML）](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriestrading.ts) | 固定价格刊登的创建、修改、重新刊登和结束 |
| [Developer](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriesdeveloper.ts) | 速率限制、签名密钥、客户端注册 |
| [Token Management](https://github.com/YosefHayim/ebay-mcp/tree/v1.15.0/src/tools/categoriestokenManagement.ts) | OAuth URL 生成与令牌管理 |
...
一个本地的 [Model Context Protocol](https://modelcontextprotocol.io) 服务器，向 AI 助手提供 **299 个工具**，覆盖 **eBay Sell API 的 100%**（270 个端点）—— 库存、订单履行、营销、分析和开发者工具。
...
299 个工具，覆盖 270 个唯一端点 —— eBay Sell API 的 100%。
