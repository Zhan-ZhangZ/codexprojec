...
- **Tool gating** (`EBAY_MCP_TOOLS`): `all` exposes everything; `dynamic` exposes
  ...
  small); a family list exposes just those. Applied in [`runtime.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/mcp/runtime.ts).
- **Transports**: [`index.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/index.ts) (STDIO) and [`serverHttp.ts`](https://github.com/YosefHayim/ebay-mcp/blob/v1.15.0/src/serverHttp.ts) (HTTP) wrap the
