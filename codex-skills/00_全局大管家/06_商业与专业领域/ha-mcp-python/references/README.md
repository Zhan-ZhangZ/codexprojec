...
[Full app documentation →](https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/homeassistant-addon/DOCS.md)
...
For the HA app, the same option is documented in [`https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/homeassistant-addon/DOCS.md`](https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/homeassistant-addon/DOCS.md#enable_tool_search) along with the in-app settings UI for fine-grained tool enable/disable/pin.
...
For comprehensive testing documentation, see **[https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/README.md](https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/README.md)**.
