...
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py`: FastMCP 3.4.6 compatibility subclass for scope setup, DCR and authorization normalization, persisted-client migration, and refresh-token scope enforcement.
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py`: focused real-provider tests for inherited constructor compatibility, DCR defaults and optional scopes, protected-resource metadata, upstream authorization scopes, persisted-client migration, and refresh-token rejection.
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py`: pinned proxy-construction contract plus regression coverage for the required OIDC scope, explicit compatibility setup call, enabled FastMCP logger level, and disabled FastMCP logging behavior.
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py`: common logging setup and standalone/container OIDC proxy construction.
...
**Files:**
- Create: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py`
- Create: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py`
- Modify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py`
- Modify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py`
...
Create `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py` with a real `OIDCConfiguration`,
...
Create `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py` with `HaMcpOIDCProxy(OIDCProxy)` and a
...
git rev-parse --abbrev-ref HEAD
git diff --check
git add https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py
...
**Files:**
- Modify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py:7-10,187-269`
- Modify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py:485-518`
...
Add `import logging` with the standard-library imports at the top of `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py`:
...
git rev-parse --abbrev-ref HEAD
git diff --check
git add https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py
...
- Modify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py:1618-1625`
...
```bash
rg -n "openid|optional|authorization|DCR|refresh|cache|Authelia|OIDC_VERIFY_ID_TOKEN|access_token_signed_response_alg|LOG_LEVEL|FASTMCP_LOG_ENABLED" ../../../docs/oidc.md https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py
git diff -- ../../../docs/oidc.md https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py
git diff --check
```
...
pwd
git rev-parse --abbrev-ref HEAD
git add ../../../docs/oidc.md https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py
...
**Files:**
- Verify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py`
- Verify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py`
- Verify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py`
- Verify: `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py`
- Verify: `../../../docs/oidc.md`
...
```bash
proot-distro login ubuntu --bind /data/data/com.termux/files/home:/mnt/termux -- sh -lc 'cd /mnt/termux/ha-mcp/worktree/fix-oidc-authelia && UV_LINK_MODE=copy uv run ruff format --check https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py'
proot-distro login ubuntu --bind /data/data/com.termux/files/home:/mnt/termux -- sh -lc 'cd /mnt/termux/ha-mcp/worktree/fix-oidc-authelia && UV_LINK_MODE=copy uv run ruff check https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py'
...
Expected: `3 passed` and a clean tracked working tree. If restoration changes a committed line, compare it with `git diff HEAD -- https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/__main__.py` and correct it before proceeding.
