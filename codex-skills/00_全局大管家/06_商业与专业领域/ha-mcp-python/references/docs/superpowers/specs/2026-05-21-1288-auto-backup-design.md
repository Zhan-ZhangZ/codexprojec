...
**Unit (`https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_backup_manager.py`):**
...
**New:**
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/backup_manager.py`
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/tools/auto_backup.py` (decorator)
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_backup_manager.py`
- `tests/src/e2e/workflows/auto_backup/` (one test file per domain)

**Modified:**
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/config.py` (4 settings)
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/tools/backup.py` — merge `ha_backup_create`+`ha_backup_restore` into a single `ha_manage_backup` polymorphic tool; add the `edits` scope handlers
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/settings_ui/__init__.py` (5 routes + Backups tab)
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/homeassistant-addon/config.yaml` + `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/homeassistant-addon-dev/config.yaml` (4 options + schema)
- `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/homeassistant-addon-dev/translations/en.yaml` (4 translations)
