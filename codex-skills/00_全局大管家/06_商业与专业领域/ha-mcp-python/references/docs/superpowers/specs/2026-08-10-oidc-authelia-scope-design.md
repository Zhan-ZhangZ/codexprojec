...
`https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_entrypoint.py` and focused compatibility coverage in
`https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/tests/src/unit/test_oidc_compat.py`:
...
2. Before adding `https://github.com/homeassistant-ai/ha-mcp/blob/v8.4.0/src/ha_mcp/auth/oidc_compat.py`, collect the new focused test
