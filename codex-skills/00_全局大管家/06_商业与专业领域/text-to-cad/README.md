...
<img src="https://github.com/earthtojake/text-to-cad/raw/main/assets/text-to-cad-demo.gif" alt="Demo of the CAD skill generating and previewing CAD geometry" width="100%">
...
<table>
  <tr>
    <td width="33%">
      <a href="https://github.com/earthtojake/text-to-cad/raw/main/assets/text-to-cad-demo.gif">
        <img src="https://github.com/earthtojake/text-to-cad/raw/main/assets/text-to-cad-demo.gif" alt="CAD skill demo showing generated geometry in CAD Viewer" width="100%">
      </a>
      <a href="./skills/cad/SKILL.md"><strong>CAD</strong></a>
    </td>
    <td width="33%">
      <a href="https://github.com/earthtojake/text-to-cad/raw/main/assets/urdf-demo.gif">
        <img src="https://github.com/earthtojake/text-to-cad/raw/main/assets/urdf-demo.gif" alt="URDF skill demo showing robot description output in CAD Viewer" width="100%">
      </a>
      <a href="./skills/urdf/SKILL.md"><strong>URDF</strong></a>
    </td>
    <td width="33%">
      <a href="https://github.com/earthtojake/text-to-cad/raw/main/assets/srdf-moveit2-demo.gif">
        <img src="https://github.com/earthtojake/text-to-cad/raw/main/assets/srdf-moveit2-demo.gif" alt="SRDF MoveIt2 skill demo showing inverse kinematics in CAD Viewer" width="100%">
      </a>
...
workflow in [CONTRIBUTING.md](https://github.com/earthtojake/text-to-cad/blob/main/CONTRIBUTING.md).
...
[CONTRIBUTING.md](https://github.com/earthtojake/text-to-cad/blob/main/CONTRIBUTING.md).
