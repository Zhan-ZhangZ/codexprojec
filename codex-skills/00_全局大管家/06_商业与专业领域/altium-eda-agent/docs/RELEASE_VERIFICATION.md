...
[`test_cross_validate.py`](https://github.com/salitronic/eda-agent/blob/1b60105cbe0c4bd557007b87bc04dda2fd4ef9a1/tests/test_cross_validate.py) pins against the FPC-compiled originals,
...
This covers what [`test_enum_vocabularies.py`](https://github.com/salitronic/eda-agent/blob/1b60105cbe0c4bd557007b87bc04dda2fd4ef9a1/tests/test_enum_vocabularies.py) cannot. That test
...
[`test_no_double_unescape.py`](https://github.com/salitronic/eda-agent/blob/1b60105cbe0c4bd557007b87bc04dda2fd4ef9a1/tests/test_no_double_unescape.py) pins the site count at zero from
