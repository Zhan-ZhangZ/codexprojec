...
and its release. [`test_foreground_guard.py`](https://github.com/salitronic/eda-agent/blob/1b60105cbe0c4bd557007b87bc04dda2fd4ef9a1/tests/test_foreground_guard.py) enforces this per
