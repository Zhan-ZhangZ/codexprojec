<div align="center">
  <a href="https://github.com/OpenByteInc/QuantDinger">
    <img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/screenshots/logo.jpg" alt="QuantDinger logo" width="180" height="180">
  </a>
  ...
  <p>
    ...
    <a href="https://x.com/QuantDinger_EN"><img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/badges/x-quantdinger.svg" alt="X @QuantDinger_EN"></a>
  </p>

  <p>
    <a href="LICENSE"><img src="https://img.shields.io/badge/License-Apache%202.0-blue.svg?style=flat-square" alt="Apache 2.0"></a>
    <img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/badges/python-3.12.svg" alt="Python 3.12">
    ...
    <img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/badges/docker-compose.svg" alt="Docker Compose">
    <a href="https://github.com/OpenByteInc/QuantDinger/releases/latest"><img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/badges/latest-release.svg" alt="Latest release"></a>
  </p>
...
The source version is declared in [`VERSION`](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/VERSION). Git release tags use the
same semantic version with a leading `v`, for example `v5.0.1`.

## Architecture

<p align="center">
  <img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/screenshots/architecture-v5.png" alt="QuantDinger v5 architecture covering clients, Agent Gateway, core platform, workers, infrastructure, observability, and the closed-loop trading workflow" width="100%">
</p>

<p align="center"><sub>The editable source is available as <a href="https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/docs/screenshots/architecture-v5.svg">architecture-v5.svg</a>.</sub></p>
...
Report vulnerabilities privately according to [SECURITY.md](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/SECURITY.md). Do
...
Read [CONTRIBUTING.md](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/CONTRIBUTING.md) and [DEVELOPMENT.md](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/DEVELOPMENT.md)
...
- Trademark, branding, attribution, and watermark use is governed by
  [TRADEMARKS.md](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/TRADEMARKS.md). Apache 2.0 does not grant trademark rights.
...
- [Contributing guide](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/CONTRIBUTING.md)
