...
| Strategy Runtime | [`trading_executor.py`](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/backend_api_python/app/services/trading_executor.py) and related services | Strategy loops, signal handling, pending order generation |
...
| Background Workers | [`startup.py`](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/backend_api_python/app/startup.py), worker services | Pending orders, portfolio monitor, grid fill poller, USDT watchers |
