...
<img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/screenshots/notification_telegram_token.png" alt="Create Telegram Bot" width="100%" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
...
<img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/screenshots/notification_telegram_userid_get.png" alt="Get User ID" width="100%" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
...
<img src="https://raw.githubusercontent.com/OpenByteInc/QuantDinger/v5.0.25/docs/screenshots/notification_telegram_userid.png" alt="Configure User ID" width="100%" style="border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
