...
For the exact tool signatures, see [the MCP package README](https://github.com/OpenByteInc/QuantDinger/blob/v5.0.25/mcp_server/README.md) and [Agent OpenAPI](agent-openapi.json).
