...
- `npm run audit:release` ([release-audit script](https://github.com/rookslog/zlibrary-mcp/blob/v1.4.0/scripts/release-audit.mjs)) and a
  ...
  incidents that motivated them: [RELEASE_PROCESS.md](https://github.com/rookslog/zlibrary-mcp/blob/v1.4.0/docs/RELEASE_PROCESS.md).
