...
- [PATTERNS.md](https://github.com/rookslog/zlibrary-mcp/blob/v1.4.0/.claude/PATTERNS.md) - Code patterns and best practices
- [ISSUES.md](https://github.com/rookslog/zlibrary-mcp/blob/v1.4.0/ISSUES.md) - Known issues including ISSUE-005 (resolved)
- [ADR-002](https://github.com/rookslog/zlibrary-mcp/blob/v1.4.0/docs/adr/ADR-002-Download-Workflow-Redesign.md) - Download workflow architecture
