...
See [ADR-004-Python-Bridge-Path-Resolution.md](https://github.com/rookslog/zlibrary-mcp/blob/v1.4.0/docs/adr/ADR-004-Python-Bridge-Path-Resolution.md) for how resolution works.
