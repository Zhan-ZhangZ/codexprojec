...
!!! warning "Pointwise intervals do not support curve-level claims"
    ...
    (measured; see `https://github.com/brycewang-stanford/StatsPAI/blob/v1.23.0/docs/guides/tests/reference_parity/test_qte_uniform_inference.py`).
...
`https://github.com/brycewang-stanford/StatsPAI/blob/v1.23.0/docs/guides/tests/reference_parity/_fixtures/_generate_qte_firpo_R.R` and
...
See [`https://github.com/brycewang-stanford/StatsPAI/blob/v1.23.0/docs/guides/docs/rfc/qte_two_month_plan.md`](https://github.com/brycewang-stanford/StatsPAI/blob/v1.23.0/docs/rfc/qte_two_month_plan.md) for the
