...
See `https://github.com/brycewang-stanford/StatsPAI/blob/v1.23.0/docs/guides/tests/reference_parity/test_staggered_extended_parity.py`, Track A module
`82_staggered`, and `https://github.com/brycewang-stanford/StatsPAI/blob/v1.23.0/docs/guides/tests/test_design_based_did.py` for the Monte-Carlo
