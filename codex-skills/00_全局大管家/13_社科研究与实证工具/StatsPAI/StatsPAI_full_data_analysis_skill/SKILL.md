...
- **Paper**: JOSS submission under review; JSS materials in `Paper-JSS/README.md` and `https://github.com/brycewang-stanford/StatsPAI/blob/v1.23.0/StatsPAI_full_data_analysis_skill/docs/jss_source_audit_dossier.md`
