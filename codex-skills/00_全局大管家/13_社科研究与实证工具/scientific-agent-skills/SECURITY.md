...
- **Workflow:** [`https://github.com/K-Dense-AI/scientific-agent-skills/blob/v2.65.0/.github/workflows/security-scan.yml`](https://github.com/K-Dense-AI/scientific-agent-skills/blob/v2.65.0/.github/workflows/security-scan.yml)
