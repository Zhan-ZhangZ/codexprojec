...
Verify both directions before relying on it: `python3 https://github.com/netresearch/git-workflow-skill/blob/v1.31.1/scripts/test_reference_worktree_gate.py`
