...
a normal clone); steps 2 and 3 run in the branch worktree. `https://github.com/netresearch/git-workflow-skill/blob/v1.31.1/tests/test_advanced_git_recipes.sh`
