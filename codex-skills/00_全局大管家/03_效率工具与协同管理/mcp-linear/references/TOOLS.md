...
3. Add any necessary type guards in `https://github.com/tacticlaunch/mcp-linear/blob/v1.4.3/src/tools/type-guards.ts`
4. Add any required methods to the `LinearService` class in `https://github.com/tacticlaunch/mcp-linear/blob/v1.4.3/src/services/linear-service.ts`
5. Register the tool in `https://github.com/tacticlaunch/mcp-linear/blob/v1.4.3/src/tools/definitions/index.ts`
6. Register the handler in `https://github.com/tacticlaunch/mcp-linear/blob/v1.4.3/src/tools/handlers/index.ts`
