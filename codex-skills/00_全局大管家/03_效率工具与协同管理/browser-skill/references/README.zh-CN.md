...
插件自带 skill，所以在 dsh 下无需执行 `bsk install-skill`；但 `bsk` CLI 和浏览器扩展仍是前置条件。工具清单、配置项与观察浮层见[插件 README](https://github.com/Tencent/BrowserSkill/blob/945bf15/packages/dsh-plugin-browserskill/README.md)。
...
- [`evals/browser`](https://github.com/Tencent/BrowserSkill/blob/945bf15/evals/browser/README.zh-CN.md) — 确定性本地页面与 Agent 无关的浏览器能力测试台
