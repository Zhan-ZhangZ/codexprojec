...
the [plugin README](https://github.com/Tencent/BrowserSkill/blob/945bf15/packages/dsh-plugin-browserskill/README.md) for the tool list,
...
- [`evals/browser`](https://github.com/Tencent/BrowserSkill/blob/945bf15/evals/browser/README.md) — deterministic local pages and agent-neutral browser capability evaluation
