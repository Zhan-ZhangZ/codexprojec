...
See [CONTRIBUTING.md](https://github.com/ebullient/obsidian-vault-mcp/blob/1.0.0/CONTRIBUTING.md) for development setup, build commands, and architecture details. AI assistants should also review [CLAUDE.md](https://github.com/ebullient/obsidian-vault-mcp/blob/1.0.0/CLAUDE.md) for working guidelines.
