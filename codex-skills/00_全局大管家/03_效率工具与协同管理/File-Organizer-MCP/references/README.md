...
[![Tests](https://img.shields.io/badge/tests-835%20passing-success.svg)](https://github.com/kridaydave/File-Organizer-MCP/tree/v5.0.0/tests/)
...
2. Add an import and one `reg()` entry in `https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/src/mcp/registry.ts`.
