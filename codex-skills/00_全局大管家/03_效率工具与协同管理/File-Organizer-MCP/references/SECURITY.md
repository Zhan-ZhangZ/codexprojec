...
Reference: [AGENTS.md - 8-Layer Path Validation](https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/AGENTS.md#-8-layer-path-validation-non-negotiable)
...
- [AGENTS.md](https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/AGENTS.md) - Agent orchestration and security guardrails
...
- [https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/src/utils/file-utils.ts](https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/src/utils/file-utils.ts) - File security utilities
...
| ------------ | ---------- | ---------------------------------------------------------- |
| 3.4.2        | 2026-02-18 | Integration fixes, dead code cleanup, schema consolidation |
