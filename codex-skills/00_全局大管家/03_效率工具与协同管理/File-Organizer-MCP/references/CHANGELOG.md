...
- **Scheduler is now a standalone bin** - the watch tools
  ...
  organization is managed and run by `https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/bin/file-organizer-watch.mjs`
...
- **CI: markdownlint failures** - Fixed pre-existing violations in
  `https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/docs/FRAMEWORK.md`, `https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/docs/CONTENT_BASED_ORGANIZATION_PLAN.md`, `CHANGELOG.md`,
...
**Configuration** (`https://github.com/kridaydave/File-Organizer-MCP/blob/v5.0.0/src/config.ts`)
