...
>
> **保留决定（2026-09-24，技能库所有者批准）**：确立「上游缺陷不修技能本体」原则
> （已写入集成规则 01_integration.md）。本批 P2–P7 属对该原则的一次性批准例外：
> 修改发生时原则尚未确立，且经实测不影响（多为改善）技能使用，故**保留不回溯**。
> 此后同类情况一律只登记「已知问题 + 使用规避」，不再修改上游技能代码。
