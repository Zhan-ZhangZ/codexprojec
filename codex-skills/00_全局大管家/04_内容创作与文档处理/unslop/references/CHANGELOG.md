...
`unslop` Python package. The Python package also ships [`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/CHANGELOG.md`](https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/CHANGELOG.md)
...
- Five new PNG visual assets: `assets/hero-refresh.png`,
  ...
  `assets/demo.png`, `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/assets/statusline.png`.
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/validate.py` + `soul.py`: removed broken arXiv
  `2604.11687` / "Kalemaj et al." citation. The ID resolves to an
  unrelated paper. Threshold kept; comment marked empirical pending
  re-verification.
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/surprisal.py`: added missing arXiv ID for the
  Chakraborty et al. ICML 2024 reference.
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/unslop/test_humanize.py`: renamed shadowed `TestHumanizeFileEx`
...
- 14 ruff F401/F811/F841 hits across `tests/` and `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/evals/measure.py`
  cleaned up.
...
- **`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/reasoning.py`** — strips agent reasoning traces before
...
- **`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/surprisal.py`** — real DivEye reading via an optional
...
- **`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/unslop/test_reasoning.py`** — 19 tests: XML wrappers, markdown
  sections, idempotency, multi-block concatenation, empty/whitespace
  safety, inline-use preservation.
- **`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/unslop/test_surprisal.py`** — 9 unit tests + 2 end-to-end
...
- **`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/unslop/test_cli.py`** — 21 tests covering the CLI end-to-end:
...
- **`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/unslop/test_detect.py`** — 30 tests for the safety gate:
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/docs/research/IMPLEMENTATION_TRACE.md` gains two new rows (real DivEye
...
`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/docs/research/IMPLEMENTATION_TRACE.md` — the project's "What research
...
- **`sentence_length_cv`** in `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/stylometry.py` `StyleProfile`:
...
- Voice-match LLM prompt block (`_format_voice_targets` in
  `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/humanize.py`) now reports `cv` and `word_length_stdev`
...
- Six new unit tests in `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/unslop/test_stylometry.py::TestDivEyeProxies`
  covering uniform/bursty/scale-invariance/monotone/mixed-register/empty.

### Changed

- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/docs/research/IMPLEMENTATION_TRACE.md`: new row mapping DivEye
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/pyproject.toml`: `tool.mypy.overrides` now lists `torch`,
  ...
  dependencies of `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/detector.py` and
  `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/fetch_detectors.py`; CI runners without the heavy
...
- **Persona-drift reinforcement** in `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/hooks/unslop-mode-tracker.js`. A
  ...
  `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/hooks/unslop-activate.js` resets the counter on session start, and
  "stop unslop" also clears it. Three new integration tests in
  `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/test_hooks.py` lock the turn-8 banner, the session-start reset,
  and the stop-phrase reset.
- **AI-ism vocabulary expansion** in `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/humanize.py`
  `STOCK_VOCAB` and `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/validate.py` `AI_ISMS`: `meticulous(ly)`,
...
- **LLM-as-judge bias mitigations** in `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/evals/perceived_humanness.py`.
...
- **Detector-feedback ladder exhaustion recommendation** in
  `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/detector.py`. When the escalation ladder (balanced →
...
- **Style-memory security hardening** in `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/style_memory.py`.
...
- **Benchmark baseline** `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/benchmarks/results/baselines/post-v050-vocab-expansion-20260421.json`
  pinned at 92.0% reduction.

### Fixed

- Type-check failures in `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/structural.py` (`_SplitCandidate`
  now uses `collections.abc.Callable` instead of a string literal) and
  `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/detector.py` (explicit `str()` cast on `tokenizer.decode()`
...
- Lint failures (ruff) across `unslop/scripts` and `benchmarks` from
  ...
  `ruff check unslop/scripts benchmarks` and `mypy --config-file https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/pyproject.toml unslop/scripts` both clean.

### Changed

- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/evals/perceived_humanness.py` `--judge-model` is deprecated in favor
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/unslop/test_perceived_humanness.py` migrated to the new API;
...
- **Phase 1 structural rewriter** (`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/structural.py`). Shape-aware
...
- **Phase 3 live detector feedback loop** (`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/detector.py`).
  ...
  `--detector-feedback` CLI flag. `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/fetch_detectors.py`
  bootstrap. 12 new tests.
- **Phase 4 stylometry module** (`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/stylometry.py`).
...
- **Phase 5 soul injection** (`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/soul.py`). 18 auxiliary-
  ...
  23 new tests.
- **Phase 6 perceived-humanness benchmark** (`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/evals/perceived_humanness.py`).
...
- **`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/benchmarks/check_regression.py`** — compares latest run against pinned
...
- **Phase 7 `unslop-reasoning` sub-skill** (`skills/unslop-reasoning/
  ...
  `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/scripts/sync-mirrors.sh` and the help card.
- **Phase 8 style memory** (`https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/scripts/style_memory.py`). Persists
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/evals/plot.py` — grouped bar chart of AI-isms per prompt × condition
  (optional `plotly` + `kaleido` deps).
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/hooks/README.md` data-flow diagram (SessionStart → flag file →
  statusline reader).
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/tests/ai_detector_test.py` uses `pytest.importorskip` for its heavy ML
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/benchmarks/run.py --all-intensities --strict` — runs the full matrix and
...
- `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/benchmarks/detector_bench.py` — opt-in AI-detector harness running TMR
  ...
  0.1–0.2 pp. See `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/benchmarks/README.md`.
...
- Full study + gap analysis: `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/docs/research/IMPLEMENTATION_TRACE.md`.
