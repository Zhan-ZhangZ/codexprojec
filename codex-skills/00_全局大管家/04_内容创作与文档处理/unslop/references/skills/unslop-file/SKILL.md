...
Common layouts:
- Full repo: `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/unslop/SKILL.md` + `unslop/scripts/`
- Synced mirror: `../../skills/unslop-file/SKILL.md` + `skills/unslop-file/scripts/`
- Codex bundle: `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/plugins/unslop/skills/unslop-file/SKILL.md` + sibling `scripts/`
...
- Full comparison + gap analysis: `https://github.com/MohamedAbdallah-14/unslop/blob/v0.7.0/docs/research/IMPLEMENTATION_TRACE.md`.
