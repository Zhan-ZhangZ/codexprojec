---
name: creator-buddy
description: 创作者全域内容搜索与全栈自媒体创作运营总控套件（Creator Buddy）。覆盖公众号（定位/爆款抓取/长短文/标题/配图/排版）、小红书（起号/对标/爆款笔记/封面/文案/复盘）与短视频（选题/口播脚本/B-Roll/字幕/配乐/剪辑）三大板块，提供全域数据侦查与从选题到成稿发布的完整生产力闭环。Leading Words: 创作者总控, 公众号全流程创作, 小红书起号对标, 短视频脚本剪辑, 爆款标题生成, 全域内容搜索, 微信智能排版, 配图逻辑图生成, 自媒体运营分析
license: MIT
metadata:
  type: orchestrator
  ...
  version: "1.0.0"
  sub_suites:
    - gzh-Skills (公众号全链路创作与排版)
    - xhs-Skills (小红书起号选题与爆款文案)
    - video-Skills (短视频长视频脚本剪辑与制片)
  tags:
    - creator
    - content-search
    - xiaohongshu
