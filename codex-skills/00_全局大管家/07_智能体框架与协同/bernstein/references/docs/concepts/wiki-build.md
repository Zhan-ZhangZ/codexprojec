...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/wiki_cmd.py`
- Symbol graph: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/knowledge/ast_symbol_graph.py`
- Renderer: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/knowledge/wiki_renderer.py`
