...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/memory/jsonl_log.py`
- Companion store: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/memory/sqlite_store.py`
- CLI surface: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/memory_cmd.py`
