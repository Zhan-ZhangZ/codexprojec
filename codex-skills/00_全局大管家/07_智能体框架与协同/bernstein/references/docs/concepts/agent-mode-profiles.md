...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/mode_profile.py`
- Profiles: `templates/mode_profiles/`
- Spawner: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_prompt.py`
