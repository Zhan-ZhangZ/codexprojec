...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/review_pipeline/abstract_diff.py`
- PR generation: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/review_responder/pr_gen.py`
