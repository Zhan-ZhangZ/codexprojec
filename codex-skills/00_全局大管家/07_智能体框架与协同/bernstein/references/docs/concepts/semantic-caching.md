...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/knowledge/semantic_cache.py` — `SemanticCacheManager`, `ResponseCacheManager`, `SemanticCacheEntry`.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/cache_cmd.py` — `bernstein cache list/inspect/clear`.
