...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/phase_pipeline.py`
  (`route_for_phase`, `PhasedRunner`, `ArtifactStore`)
- Plan loader: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/plan_loader.py`
- Model router: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/router.py`
- PR #1000
