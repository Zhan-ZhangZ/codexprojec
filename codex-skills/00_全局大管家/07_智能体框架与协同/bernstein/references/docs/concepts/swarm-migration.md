...
YAMLs (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/templates/migrations/sync_to_async.yaml`,
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/templates/migrations/pytest_asyncio.yaml`) document the same shape the
`MigrationPlan` dataclass accepts:

```yaml
# https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/templates/migrations/sync_to_async.yaml
glob: 'src/**/*.py'
transform_prompt: |
...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/swarm_migration.py`
- CLI: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/migrate_cmd.py`
