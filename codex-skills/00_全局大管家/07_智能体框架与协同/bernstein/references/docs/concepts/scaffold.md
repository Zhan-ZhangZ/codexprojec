...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/scaffold_cmd.py`
- Templates: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/scaffold/templates.py`
