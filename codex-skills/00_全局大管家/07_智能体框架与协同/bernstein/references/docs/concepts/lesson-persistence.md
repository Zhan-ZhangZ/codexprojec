...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/knowledge/lessons.py` (imported elsewhere as
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/knowledge/memory_integrity.py`. Reordering, deleting, or
