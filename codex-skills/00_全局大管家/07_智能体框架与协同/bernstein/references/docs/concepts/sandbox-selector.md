...
A [named sandbox pool](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/sandbox-pools.md) composes with the selector
...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/selector.py`
- Pool placement: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/pool_placement.py`
- Registry: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/registry.py`
- [Named sandbox pools](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/sandbox-pools.md)
