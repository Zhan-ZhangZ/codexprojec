...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/feature_contract.py`
- Audit hook: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/audit.py`
- Janitor integration: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/janitor.py`
- PR #997
