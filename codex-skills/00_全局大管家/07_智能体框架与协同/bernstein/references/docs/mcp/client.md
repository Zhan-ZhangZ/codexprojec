...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/protocols/mcp/mcp_client.py`
(`MCPClientSession`, `MCPClientManager`) and
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/cost/mcp_server_cost.py` (`MCPServerCostMeter`).
...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/protocols/mcp/stateless_core.py`):
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/mcp/test_client_hardened.py` exercises every acceptance path with
...
shape. The legacy surface remains covered by `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_mcp_client.py`.
