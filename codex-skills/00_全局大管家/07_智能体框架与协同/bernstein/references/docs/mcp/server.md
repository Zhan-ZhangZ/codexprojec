...
[Available tools](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/cloudflare/cloudflare-mcp.md#available-tools). Unifying
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_mcp_server.py`:
...
The `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/mcp/server.py` module docstring lists every tool the
