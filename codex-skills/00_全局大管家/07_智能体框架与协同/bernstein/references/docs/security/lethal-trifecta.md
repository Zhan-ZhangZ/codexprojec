...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_core.py:_enforce_lethal_trifecta`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/core/agents/spawner_core.py).
...
|---|---|---|
| `outer-envelope` | `adapter.<name>` | Every adapter row in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/templates/capabilities/adapters.yaml` is tagged with all three capabilities by design - it describes the envelope a running CLI agent sits in, not a single call. Evaluating it would deny every spawn under `enforce`. |
...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/capability_matrix.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/policy_engine.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_core.py`
