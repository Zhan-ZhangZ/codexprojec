...
| Layer | Source |
|-------|--------|
| Bundled fallback | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/credential-policies/default.yaml` |
...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/credential_scoping.py`.
...
3. First existing entry in `DEFAULT_POLICY_PATHS` - load it. The chain:
    ...
    6. `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/credential-policies/default.yaml` (bundled)
...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/credential_scoping.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/storage/credential_scoping.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/env_isolation.py`
- Bundled default: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/credential-policies/default.yaml`
- [Secrets and credentials](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/secrets.md) - where the
  underlying tokens live (vault, secrets-manager, env vars)
- [Env isolation](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/env-isolation.md) - sibling page
