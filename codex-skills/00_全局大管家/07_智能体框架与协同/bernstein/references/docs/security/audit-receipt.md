...
[`key_custody.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/core/security/key_custody.py)) - no new
...
```bash
python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_receipt.py --receipt audit-receipt-....json --verbose
```
...
Use `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_receipt.py` to verify the standard receipt formats and
