...
cd bernstein
https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/researcher_sandbox.sh start
```
...
https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/researcher_sandbox.sh reset

# Stop and remove all containers and volumes
https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/researcher_sandbox.sh stop
```
...
Relevant code: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner.py`, `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawn_prompt.py`
...
Relevant code: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/orchestrator.py`
...
Relevant code: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/communication/bulletin.py`
...
The terms that govern are in [`SECURITY.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/SECURITY.md); this page is
the sandbox guide.
