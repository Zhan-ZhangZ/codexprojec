...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/lineage/identity.py`). Task specs, routines, and
...
`.sdd/fleet/connections/`. Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/fleet/connection.py`.
