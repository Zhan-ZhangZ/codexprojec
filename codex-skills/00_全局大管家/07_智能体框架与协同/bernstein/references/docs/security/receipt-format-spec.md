...
The reference implementation is `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/audit_receipt.py`.
The standalone verifier `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_receipt.py` re-implements every
...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/run_attestation_receipt.py`) reuses the same
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_receipt.py` and propagates its exit code, so the operator
...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/fixtures/receipt-vectors/valid-receipt.json` — a receipt whose
  embedded range is intact.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/fixtures/receipt-vectors/tampered-receipt.json` — the same receipt
  with one embedded event mutated.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/fixtures/receipt-vectors/valid-receipt-key.pem` — the Ed25519 public
  key both were signed under.

```console
$ python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_receipt.py \
    --receipt https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/fixtures/receipt-vectors/valid-receipt.json \
    --public-key https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/fixtures/receipt-vectors/valid-receipt-key.pem
```
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_audit_receipt_format_vectors.py` asserts both verdicts against
...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/audit_receipt.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/run_attestation_receipt.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_receipt.py`, `../../schemas/audit-receipt-v1.json`.
