...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/audit_dsse.py`.
...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_dsse.py`.
