...
```yaml
# https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/templates/capabilities/adapters.yaml
tools:
  - name: adapter.claude
...
- Policy engine: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/policy_engine.py`
