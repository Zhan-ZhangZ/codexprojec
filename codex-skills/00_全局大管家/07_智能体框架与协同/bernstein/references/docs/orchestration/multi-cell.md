...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/multi_cell.py` - `MultiCellOrchestrator`,
  `CellStatus`, `MultiCellTickResult`.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/run_bootstrap.py` - the `--cells` flag on `bernstein
  run`.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/bootstrap.py` - `bootstrap_from_seed()`
