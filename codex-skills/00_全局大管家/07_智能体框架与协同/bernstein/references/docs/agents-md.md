...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/knowledge/agents_md_generator.py` - section
  builders + canonical render.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/knowledge/agents_md_bridge.py` - per-target
  translators.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/agents_md_cmd.py` - Click group with
