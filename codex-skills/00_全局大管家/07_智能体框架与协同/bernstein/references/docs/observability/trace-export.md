...
`TrustRecordEmitter` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/trust_record.py`);
...
uv run --with agentrust-trace-tests==0.5.1 trace-tests verify \
    --record https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/fixtures/trust-record-vectors/single-execution-trust-record.json \
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/advanced_cmd.py` (`trace export`),
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/trust_record.py`
