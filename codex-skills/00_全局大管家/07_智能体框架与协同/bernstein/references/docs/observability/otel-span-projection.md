...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/advanced_cmd.py` (`trace project` /
`trace verify-projection`),
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/_otel_projection_audit.py` (authenticated audit
binding verification),
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/otel_projection.py` (span projection,
signing, verification),
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/replay/journal.py` (the event journal projected from).
