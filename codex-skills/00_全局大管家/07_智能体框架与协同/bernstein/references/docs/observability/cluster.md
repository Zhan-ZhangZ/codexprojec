...
of the task server uses (see [Security and identity](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/security-and-identity.md)).
...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/prometheus.py`,
  `src/bernstein/core/security/audit_log.py`
- [Cluster mTLS setup](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/cluster/mtls-setup.md)
- [Cluster deployment patterns](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/cluster/deployment-patterns.md)
- [Operations / Observability overview](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/observability-overview.md)
- PR #1021
