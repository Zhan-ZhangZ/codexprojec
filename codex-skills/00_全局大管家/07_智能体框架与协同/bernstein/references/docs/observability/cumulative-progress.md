...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/tui/progress_bar.py` — `TaskProgress`, `render_progress_bar`,
  `render_progress_bar_text`, `render_task_progress`, `render_progress_summary`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/tui/status_bar.py` — aggregate run-level bar in the status bar
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/tui/task_list.py` — per-task "Progress" column
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/tui/app.py` — `_compute_run_pct`, polling loop that feeds both
