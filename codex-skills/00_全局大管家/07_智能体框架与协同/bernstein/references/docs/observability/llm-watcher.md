...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/llm_watcher.py`
- Cost cap: `bernstein run --max-cost-usd N` (see
  [CLI reference](../reference/cli-reference.md))
- [Capability matrix](../security/capability-matrix.md)
- [Observability overview](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/observability-overview.md)
