...
[Observability overview - Circuit breakers](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/observability-overview.md#circuit-breakers)
...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tokens/token_monitor.py` — `check_token_growth`, `read_tokens`, `_handle_budget_nudge`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/models.py` — `AgentSession.tokens_used`, `AgentSession.token_budget`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/status_dashboard.py` — `/status` payload assembly
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/status.py`, `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/status_cmd.py`, `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/ui.py` — `bernstein status` command and table rendering
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_core.py` — per-task token budget assignment
