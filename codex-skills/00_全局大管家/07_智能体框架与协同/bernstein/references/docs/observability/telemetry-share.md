...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/telemetry/events.py`. Field-by-field:
...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/telemetry/test_event_schema_guard.py`): any new field that lacks
