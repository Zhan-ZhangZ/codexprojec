...
Eight routes. Source: `web/src/routes/`. Design tokens: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/web/src/index.css`.

## Screenshots

![Tasks page with Diff drawer open](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-agents-diffs.png)

![Agents grid with token meter drawer](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-agents-panel.png)

![Tasks — empty state, filter chips and Run new task button](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-tasks.png)

![Agents — agent card grid view](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-agents.png)

![Approvals — empty approvals queue](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-approvals.png)

![Audit — audit log with chain status and filters](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-audit.png)

![Costs — KPI cards, sparkline and by-adapter table](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-costs.png)

![Fleet — fleet management scaffold](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-fleet.png)

![Settings — settings placeholder screen](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/assets/webui-settings.png)

## Tasks (`/ui/tasks`, default route)

- **Source:** `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/web/src/routes/Tasks.tsx`.
...
- **Source:** `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/web/src/routes/Agents.tsx`.
...
- **Source:** `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/web/src/routes/Approvals.tsx`.
...
- **Source:** `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/web/src/routes/Audit.tsx`.
...
- **Source:** `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/web/src/routes/Costs.tsx`.
...
- **Source:** `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/web/src/routes/Missions.tsx`.
...
- **Endpoints:** `GET /api/v1/missions/*` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/missions.py`) - a deterministic projection folded from the mission's work-ledger chain; the server holds no mission-side state.
