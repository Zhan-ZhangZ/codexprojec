...
- The sidebar and command palette link to the server-rendered [review board](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/review-board.md) for attested merge-queue decisions.
