...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/well_known.py`.
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/well_known.py`. The reusable signer
lives in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/agent_card_signer.py`.
...
[the `.well-known` service catalog](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/protocols/well-known-manifest.md).
...
- JCS canonicalisation in
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/agent_card_signer.py` covers the value
...
- `.well-known` service catalog (index of discovery paths):
  [protocols/well-known-manifest.md](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/protocols/well-known-manifest.md).
- Operator security runbook:
  [operations/security-and-identity.md](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/security-and-identity.md).
- Source:
  - `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/well_known.py` - routes, body builder, JWS attach.
  - `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/agent_card_signer.py` - JCS, JWS, keypair primitives.
  - `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/agent_card_keystore.py` - file-backed keystore.
  - `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/auth_middleware.py` - RFC 8707 audience binding.
