...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/batch_router.py` — `classify_batch_mode`, `BatchClassification`, `apply_batch_discount`.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/cost/scheduling/batch.py` — `route_batch`, `BatchRouteDecision`.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/_contract.py` — `BatchDispatchCapability`, `batch_dispatch_capability`.
