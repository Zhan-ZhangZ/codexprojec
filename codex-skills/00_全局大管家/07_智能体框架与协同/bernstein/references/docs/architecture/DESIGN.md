...
- `src/bernstein/core/orchestrator.py` (shim) -> `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/orchestrator.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/tick_pipeline.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/task_lifecycle.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/agent_lifecycle.py`
...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/trigger_manager.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/models.py` (`TriggerEvent`, trigger config models)

Current source adapters:

- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/trigger_sources/slack.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/trigger_sources/discord.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/trigger_sources/file_watch.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/trigger_sources/webhook.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/trigger_sources/webhook_node.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/trigger_sources/schedule.py`
...
- Worker CLI: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/worker_cmd.py`
- Cluster data model/policy: `src/bernstein/core/protocols/cluster/`
- Cluster API routes in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/task_cluster.py` and `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/tasks.py`
...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/hookspecs.py`
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/manager.py`
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/lifecycle.py`. Every transition is validated against an
...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/agent_turn_state.py`.
