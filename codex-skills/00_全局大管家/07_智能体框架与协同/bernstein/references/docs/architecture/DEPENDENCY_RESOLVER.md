...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/check_dependencies.py` detects dependency problems and suggests
...
```bash
uv run python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/check_dependencies.py --output .sdd/dependency-report.json
```
...
3. Validate with the full test suite: `uv run python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/run_tests.py -x`.
