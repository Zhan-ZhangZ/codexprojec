...
The `microvm` backend (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/backends/microvm.py`)
...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/microvm-libkrun.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/microvm-libkrun.md).
...
**Fork-and-race** (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/fork_race.py`).
...
**Selection receipt** (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/selection_receipt.py`).
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/sandbox/test_fork_race.py`). The real libkrun boot/exec/freeze
round trip is covered by the host-gated
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/integration/sandbox/test_microvm_libkrun.py` (opt in with
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/integration/sandbox/test_microvm_firecracker.py`. The refusal-invariant
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/conformance.py`) is a parametrised pytest
...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/sandbox/test_backend_protocol.py`). Docker / E2B /
