...
`classify_task()` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/fast_path.py`) runs on every
...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/fast_path.py` - classification, executors,
  config loading, metrics recording.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/orchestrator.py` - wiring at
  orchestrator startup (`load_fast_path_config`) and stats tracking.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/task_lifecycle.py` - calls
