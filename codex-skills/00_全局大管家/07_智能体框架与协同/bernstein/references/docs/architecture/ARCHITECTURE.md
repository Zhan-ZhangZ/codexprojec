...
The cloud bridges implement the same `RuntimeBridge` interface as local execution, so the orchestrator remains agnostic to where agents run. See the [Cloudflare Overview](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/cloudflare/cloudflare-overview.md) for architecture diagrams and setup instructions.
...
- **[Benchmarks](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/benchmarks/BENCHMARKS.md)** - performance baseline and methodology
...
- **[What's New](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/whats-new.md)** - recent user-facing changes
