...
| Concern | File |
|---------|------|
| Controller state machine | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/adaptive_parallelism.py` |
| Defaults | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/defaults.py` (`ParallelismDefaults`) |
| Orchestrator integration | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/orchestrator.py` |
