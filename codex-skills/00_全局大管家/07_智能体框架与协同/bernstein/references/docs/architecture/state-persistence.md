...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal.py`.
...
Source files: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal_replay.py`,
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/task_store_core.py`.
...
`CASStore` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/cas_store.py`) deduplicates
...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/merkle.py`).
...
| Concern | File | Symbol |
|---------|------|--------|
| WAL writer (append, fsync, hash chain) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal.py` | `WALWriter` |
| WAL reader + chain verification | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal.py` | `WALReader` |
| WAL recovery scan (all runs) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal.py` | `WALRecovery` |
| Sidecar uncommitted index | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal.py` | `UncommittedIndex` |
| Replay engine | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal_replay.py` | `WALReplayEngine` |
| Idempotency store | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/wal_replay.py` | `IdempotencyStore` |
| Stale-claim recovery | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/task_store_core.py` | `recover_stale_claimed_tasks` |
| CAS store | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/cas_store.py` | `CASStore` |
| Merkle seal builder | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/merkle.py` | `file_leaf_hash`, tree builder |
| Backlog ingest (open → claimed) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/orchestrator.py` | `Orchestrator.ingest_backlog`, `Orchestrator._claim_backlog_file` |
| Backlog sync (yaml ↔ task server) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/sync.py` | `BacklogTask` |
| Disaster-recovery backup paths | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/disaster_recovery.py` | `_BACKUP_DIRS` |
