...
- [ADR-001: Agent Lifecycle Model](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/decisions/001-agent-lifecycle.md) - Full analysis of hunger vs. pull vs. short-lived models with multi-agent pilot data
- [ADR-006: No Embedded LLM in the Orchestrator](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/decisions/006-no-embedded-llm.md) - Why the control plane is deterministic code
