...
`LoopDetector` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/loop_detector.py`) tracks
...
`check_loops_and_deadlocks(orch)` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/agent_recycling.py`,
...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/loop_detector.py` - `LoopDetector`,
  `DeadlockDetection`, cycle search, and victim selection.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/agent_recycling.py` and
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/agent_lifecycle.py` - `check_loops_and_deadlocks()`,
  the tick-loop entry point (the orchestrator imports the copy in
  `agent_recycling.py`).
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/orchestrator.py` - tick-loop wiring and
  `_check_file_overlap` (`check_conflicts()` call site).
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/file_locks.py` - `FileLockManager`,
