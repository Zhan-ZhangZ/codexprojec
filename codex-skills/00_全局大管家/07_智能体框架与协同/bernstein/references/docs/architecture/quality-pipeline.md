...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/janitor.py`. The janitor is the
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_policy.py`. pytest then exits during collection without running
...
[https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/artifacts.md](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/artifacts.md).
...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/gate_pipeline.py`,
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/quality_gates.py`,
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/gate_runner.py`,
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/gate_plugins.py`.
...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/cross_model_verifier.py`. This is the
...
contract is in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py`.
...
quality_gates:
  ...
  tests: false
  test_command: "uv run python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/run_tests.py -x"
  timeout_s: 120
...
[Observability overview](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/observability-overview.md) for
...
| Concern                          | File                                                       |
| -------------------------------- | ---------------------------------------------------------- |
| Janitor                          | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/janitor.py`                    |
| Gate pipeline structure          | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/gate_pipeline.py`              |
| QualityGatesConfig (yaml schema) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/quality_gates.py`              |
| Gate execution                   | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/gate_runner.py`                |
| Custom gate plugin discovery     | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/gate_plugins.py`               |
| Cross-model verifier             | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/cross_model_verifier.py`       |
| Quality score scoring            | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/quality_score.py`              |
| Review pipeline (LLM review)     | `src/bernstein/core/quality/review_pipeline/`              |
| Cascade router (escalation)      | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py`             |
| Cross-adapter cascade fallback   | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade.py`                    |
| Quality HTTP routes              | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/quality.py`                     |
| File health routes               | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/file_health.py`                 |
