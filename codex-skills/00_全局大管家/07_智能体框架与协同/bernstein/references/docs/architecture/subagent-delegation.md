...
- `bernstein delegation verify <run>` verifies a **different** surface -
  ...
  [Deterministic replay](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/deterministic-replay.md)) and, when
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/subagent_delegation.py`
