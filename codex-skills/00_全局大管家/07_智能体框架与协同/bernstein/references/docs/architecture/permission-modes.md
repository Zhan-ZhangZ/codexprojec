...
| File                                                    | What it does |
|---------------------------------------------------------|--------------|
| `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/permission_mode.py`        | Canonical `PermissionMode` enum, `resolve_mode()`, compatibility matrix |
| `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/permission_rules.py`       | `PermissionRuleEngine` - matches rules, applies mode relaxation |
| `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/permission_matrix.py`      | `PermissionResolutionMatrix` - combines rule outcome with hook outcome |
| `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/approval.py`               | Approval gate - honours `bypass_enabled` when mode is `bypass` |
| `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_permission_mode.py`                    | 62 tests covering every cell of the matrix |
...
- [`operations/runbooks.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/runbooks.md) - automated
