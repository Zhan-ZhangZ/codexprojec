...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/memory/compaction/tiers.py`).
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/observability/traces.py`) carrying:
...
- The existing session-memory store
  (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/memory/session_memory.py`) is unchanged; the
