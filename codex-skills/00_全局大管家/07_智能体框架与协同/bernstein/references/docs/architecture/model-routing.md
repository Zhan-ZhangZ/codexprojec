...
[`operations/task-tier-classification.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/task-tier-classification.md).

---

## System 1 - Intra-Claude tier escalation (CascadeRouter)

`CascadeRouter` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py`)
...
`CASCADE` is defined in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/cost/cost.py`:
...
`EpsilonGreedyBandit` lives in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/cost/cost.py`. It
...
`CascadeFallbackManager` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade.py`)
...
### CLI flags (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/main.py`)
...
|---------|------|---------------|
| Cascade router selection | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `CascadeRouter.select:330` |
| Initial model picker | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `_select_initial_model` |
| Escalation decision | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `record_and_escalate`, `_should_escalate` |
| Low-confidence regex | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `_LOW_CONFIDENCE_PATTERN`, `detect_low_confidence` |
| Tier ladder | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/cost/cost.py` | `CASCADE` |
| `_cascade_for_task` (high-stakes branch) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `_cascade_for_task` |
| Bandit arm | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/cost/cost.py` | `EpsilonGreedyBandit`, constants `EPSILON/MIN_OBSERVATIONS/QUALITY_THRESHOLD` |
| Proactive-skip rule | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `_select_initial_model` |
| Chain persistence | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `save_chain`, `CHAIN_FILE` |
| Aggregate savings | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade_router.py` | `load_cascade_savings_summary` |
| Cross-adapter fallback | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade.py` | `CascadeFallbackManager`, `find_fallback` |
| Default cascade order | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade.py` | `DEFAULT_CASCADE_ORDER` |
| Capability floor | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade.py` | `CAPABILITY_FLOOR`, `_is_viable_candidate` |
| Sticky fallback | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routing/cascade.py` | `_DEFAULT_STICKY_DURATION_S`, `get_sticky_fallback` |
| `/routing/bandit` endpoint | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/routes/status_dashboard.py` | `bandit_routing_stats` |
| `--routing` CLI flag | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/main.py` | - |
