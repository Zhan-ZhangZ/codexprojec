...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/plan_schema.py` (schema),
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/plan_loader.py` (YAML → Task list),
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/planner.py` (LLM-driven planning).
...
see [operations/task_format.md](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/task_format.md). Source:
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/context_attachments.py`.
...
| Concern | File |
|---------|------|
| JSON schema + manual validation | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/plan_schema.py` |
| YAML loader (plan → tasks) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/plan_loader.py` |
| LLM-driven planning (manager agent) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/planner.py` |
| Plan-and-execute tier (cost-aware) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/plan_execute.py` |
| Markdown rendering for review | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/plan_builder.py` |
| Workflow DSL (conditional DAG) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/workflow_dsl.py` |
| Role resolver | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/role_resolver.py` |
| Duration predictor | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/planning/duration_predictor.py` |
| `bernstein validate` CLI | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/plan_validate_cmd.py` |
| `bernstein plan generate` CLI | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/plan_generate_cmd.py` |
