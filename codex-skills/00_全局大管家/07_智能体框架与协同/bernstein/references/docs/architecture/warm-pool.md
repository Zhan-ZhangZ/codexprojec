...
| Concern | File |
|---------|------|
| Pool data structures + state machine | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/warm_pool.py` |
| YAML config loader | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/warm_pool.py` (`load_warm_pool_config`) |
| Spawner integration (claim) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_core.py` |
| Spawner integration (release) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_core.py` |
| Routing helper that picks model tier per slot | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_warm_pool.py` |
