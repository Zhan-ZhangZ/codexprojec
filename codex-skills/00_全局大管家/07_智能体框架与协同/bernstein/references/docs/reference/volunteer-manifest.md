...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/volunteer/test_bernstein_own_manifest.py` holds all three: the lint
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/volunteer/manifest.py`.
