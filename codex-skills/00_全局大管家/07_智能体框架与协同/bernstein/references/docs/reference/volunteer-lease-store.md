...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/tasks/task_store_core.py:432-451`, deliberately copied
...
`preflight_multi_worker_guard` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/server/server_app.py:933`)
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/volunteer/lease_store.py`.
