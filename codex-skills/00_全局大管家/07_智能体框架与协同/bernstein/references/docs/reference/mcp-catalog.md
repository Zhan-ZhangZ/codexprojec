...
The Bernstein MCP catalog is a community registry of installable [Model Context Protocol](https://modelcontextprotocol.io) servers. It shipped in **release 1.9** and lives at `bernstein mcp catalog` (registered as a subgroup of `bernstein mcp` in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/main.py`). Browse, search, install, upgrade, and uninstall MCP servers without hand-editing your client config.
...
> Every flag below is cited as `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/mcp_catalog_cmd.py:<line>`.
...
- **Audit log** - every fetch / install / upgrade / uninstall emits an HMAC-chained event under `.sdd/audit/`. Override directory via `BERNSTEIN_MCP_CATALOG_AUDIT_DIR` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/mcp_catalog_cmd.py`).
...
*(source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/mcp_catalog_cmd.py`)*
...
All five env vars come from `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/mcp_catalog_cmd.py`.
