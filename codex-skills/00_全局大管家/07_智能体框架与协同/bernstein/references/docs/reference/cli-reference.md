...
| `bernstein undo` | Undo the last operation. `--dry-run TASK_ID` prints the paths that task changed and exits without touching the tree ([task revert](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/task-revert.md)). | `cli/commands/undo_cmd.py:22` |
...
See [`operations/cluster-mode.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/cluster-mode.md) for the full setup walkthrough.
...
See [Updates: check, verify, apply](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/updates.md).
...
Disaster recovery; see [`operations/disaster-recovery.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/disaster-recovery.md).
...
| `bernstein schedule routine export\|provision\|register\|bindings` | Bridge a scenario to an external Routine session and back (`bernstein routine` is a deprecated alias, removed in 4.0.0). See [routine scenarios](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/routine-scenarios.md). | `cli/commands/routine_cmd.py` |
...
Experimental voice control (see [`operations/voice-control.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/voice-control.md) when published).
...
- [`operations/CONFIG.md`](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/CONFIG.md) - every config key Bernstein recognises.
...
[Provider availability & failover](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/provider-availability.md).
...
MCP catalog entry (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/packaging/docker-mcp/server.yaml`) resolve to the same
