...
[deterministic replay](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/deterministic-replay.md#signed-run-receipt-one-file-offline-verification).
...
one covered in full in the [air-gap installation guide](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/installation/air-gap.md) —
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/verify_cmd.py` (command group);
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/replay/run_receipt.py` (receipt build + offline verify);
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/receipt_key_chain.py` (key succession chain);
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/verifier_ladder.py` (ladder receipts);
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/plugins_core/plugin_pin_manifest.py` (pin manifest,
