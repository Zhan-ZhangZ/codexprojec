...
### Overrides (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/overrides/main.html`)
...
In `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/requirements.in`:
```ini
