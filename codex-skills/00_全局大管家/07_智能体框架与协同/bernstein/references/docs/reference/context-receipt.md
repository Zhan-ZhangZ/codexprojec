...
See [Context policy configuration](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/context-policy.md) for details
...
- [Context policy configuration](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/context-policy.md) — How to
  configure policy in `bernstein.yaml`
- [Deterministic replay](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/deterministic-replay.md) — How context
