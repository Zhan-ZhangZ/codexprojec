...
[run savings summary](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/cost-optimization.md#run-savings-summary)
...
- **[Configuration reference](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/CONFIG.md)** - every `bernstein.yaml` option,
...
- **[Cost optimization](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/cost-optimization.md)** - mix cheap and heavy models,
