...
[CONFIG.md](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/CONFIG.md)).
...
- [Configuration reference](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/CONFIG.md) - full `bernstein.yaml` options
...
- [Deployment guide](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/deployment-guide.md) - Docker, Kubernetes, CI/CD
- [Cost optimization](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/cost-optimization.md) - reduce API spend
