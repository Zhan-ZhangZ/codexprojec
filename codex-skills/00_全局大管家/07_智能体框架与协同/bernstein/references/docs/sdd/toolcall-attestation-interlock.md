...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/bench_toolcall_interlock.py` compares full
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/bench_toolcall_identity.py` separately compares the native signed
