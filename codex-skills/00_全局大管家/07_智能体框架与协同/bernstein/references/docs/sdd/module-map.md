...
| `grpc_gen/`                 | Generated gRPC stubs - run ``https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/generate_proto.sh`` to populate |
...
| `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/run_tests.py`     | Per-file isolated test runner |
