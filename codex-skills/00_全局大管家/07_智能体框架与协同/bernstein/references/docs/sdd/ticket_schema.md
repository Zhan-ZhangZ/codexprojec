...
uv run pytest https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/property/test_ticket_validator_properties.py -x -q
uv run pytest https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/integration/test_ticket_validate_cli.py -x -q
```
