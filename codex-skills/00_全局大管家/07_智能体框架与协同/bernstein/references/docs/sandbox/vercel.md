...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/sandbox/backends/vercel.py` -
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/integration/sandbox/test_vercel_backend.py` skips cleanly.
