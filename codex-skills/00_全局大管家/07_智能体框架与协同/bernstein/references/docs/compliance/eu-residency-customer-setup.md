...
- [`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/build_airgap_wheelhouse.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/scripts/build_airgap_wheelhouse.py)
