...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/lineage.py:96`.
...
2. **Per-task in `bernstein.yaml`** - set
   ...
   class
   (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/lineage.py:374`).
...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/lineage_export_cmd.py`.
...
Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/lineage_verify_cmd.py`. Walks
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/quality/janitor.py:187`. Webhook configuration:
...
([compliance.md § assess](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/compliance.md#assess-generate-the-eu-ai-act-evidence-package))
...
- [Compliance](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/compliance.md) - `bernstein compliance`
  CLI for EU AI Act, SOC 2, ISO 27001, PCI-DSS, NIST 800-53, HIPAA.
- `security/AUDIT.md` - HMAC-chained audit log.
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/persistence/lineage.py`,
