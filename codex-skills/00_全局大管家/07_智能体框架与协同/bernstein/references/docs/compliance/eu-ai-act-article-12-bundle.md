...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/article12_bundle.py`.
...
```bash
python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_dsse.py \
...
- [Compliance CLI](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/compliance.md) - `bernstein compliance
  assess` for the Annex IV / Article 43 paperwork.
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/article12_bundle.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/security/audit_dsse.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tools/verify_audit_dsse.py`.
