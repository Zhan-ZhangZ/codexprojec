...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/hookspecs.py`, which is the canonical contract.
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/logging_plugin.py` - ships with Bernstein.  Prints every
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/slack_notifier.py` - posts failure and completion alerts to
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/discord_notifier.py` - posts alerts to a Discord channel
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/metrics_plugin.py` - appends structured JSON events to
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/quality_gate_plugin.py` - runs a security scan after every
task completes.
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/custom_router_plugin.py` - tracks cumulative model spend and
...
See `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/custom_router_plugin.py` for the full source (~250 lines).

---

### Jira sync

`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/jira_plugin.py` - keeps Jira issues and Bernstein tasks in
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/examples/plugins/linear_plugin.py` - mirrors task state changes to Linear
