...
Defined in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/hookspecs.py`:
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_plugins.py` shows the established pattern:
...
|---------|------|---------------|
| Hook spec | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/hookspecs.py` | `provide_mcp_servers` |
| Plugin-side dispatch | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/manager.py` | `collect_plugin_mcp_servers` |
| Dict → entry conversion | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/manager.py` | `_mcp_entry_from_dict` |
| Per-plugin registration & namespacing | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/plugins/manager.py` | `_register_plugin_mcp_servers` |
| `MCPServerEntry` dataclass | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/protocols/mcp/mcp_registry.py` | `MCPServerEntry` |
| `namespaced_name` property | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/protocols/mcp/mcp_registry.py` | `namespaced_name` |
| `register_plugin_servers` | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/protocols/mcp/mcp_registry.py` | - |
| Per-task config build | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/protocols/mcp/mcp_registry.py` | `resolve_for_tasks` |
| Spawn-time merge & readiness probe | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/agents/spawner_core.py` | - |
| Orchestrator-side registry construction | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/orchestration/orchestrator.py` | - |
| Test suite | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_plugins.py` | `_MCPServerPlugin`, collision test -, error-isolation - |
