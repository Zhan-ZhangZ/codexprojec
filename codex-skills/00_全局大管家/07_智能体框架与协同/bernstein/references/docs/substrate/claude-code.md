...
| Scope | Path |
|-------|------|
| Project (current directory) | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/.mcp.json` |
...
Open `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/.mcp.json` and delete the `bernstein` key under `mcpServers`, or
