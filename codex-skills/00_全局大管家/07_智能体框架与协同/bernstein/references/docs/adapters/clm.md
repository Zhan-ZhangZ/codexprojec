...
The integration suite (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/integration/adapters/test_adapter_clm_with_fake_nim.py`)
...
* Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/clm.py`,
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/clm_tls_launcher.py`
* Shared TLS plumbing: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/core/protocols/cluster/cluster_tls.py`
* [Cluster mTLS setup](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/cluster/mtls-setup.md) - same `TLSConfig`
