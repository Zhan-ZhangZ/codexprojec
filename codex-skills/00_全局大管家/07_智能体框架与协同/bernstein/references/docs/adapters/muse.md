...
See `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/muse.py` for the adapter source and
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/contract/contracts/muse.yaml` for the pinned CLI surface.
