...
Source: [`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/capability_profile.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/adapters/capability_profile.py).
...
3. **The existing conformance suite.** Profile-built adapters are
   ...
   `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_adapter_consistency.py` protocol suite, the same
...
Run `uv run pytest https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/adapters/test_capability_profile.py` to
