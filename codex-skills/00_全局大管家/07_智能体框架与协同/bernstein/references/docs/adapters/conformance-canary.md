...
(`bernstein doctor`, see `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/advisories.py`) warn
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/adapter_canary.py`, which runs the canary matrix defined in
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/canary.py`:
...
(`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/adapter_canary.py`), so a canary finding is reconstructable
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/canary_propose_branch.py` on `origin/main` **as fetched at commit
...
other than `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/last_green.json` and
...
`uv run python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/adapter_canary.py --update-docs` if in doubt.
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/last_green.json`) and, for every locally installed
...
* **`agy`** (Antigravity) is closed-source with a **manual, no-CI install
  ...
  `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/contract/contracts/agy.yaml`): the CI runner cannot install it,
...
* Run one probe locally:
  `uv run python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/adapter_canary.py --adapter agy`.
* Regenerate this table from a local run:
  `uv run python https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/scripts/adapter_canary.py --update-docs`.
