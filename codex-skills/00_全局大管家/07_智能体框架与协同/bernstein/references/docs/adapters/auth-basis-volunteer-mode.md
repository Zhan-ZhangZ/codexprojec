...
Every adapter contract (`tests/contract/contracts/*.yaml`) declares `auth.basis` (`AuthBasis` in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/_contract.py`):
