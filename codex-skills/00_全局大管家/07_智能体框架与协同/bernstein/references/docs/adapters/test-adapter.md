...
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/cli/commands/adapter_cmd.py` — `test_adapter` command.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/registry.py` — `get_adapter`.
- `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/base.py` — `CLIAdapter.cancel_timeout`.
