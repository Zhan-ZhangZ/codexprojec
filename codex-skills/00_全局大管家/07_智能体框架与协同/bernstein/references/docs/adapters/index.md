...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/use_cases.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/adapters/use_cases.py).
...
1. Add an `AdapterCapabilityProfile` to `_PROFILE_LIST` in
   `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/capability_profile.py`.
...
4. Add an entry to `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/use_cases.py` so the new
...
1. Add a `<name>.py` module under `src/bernstein/adapters/` implementing
   `CLIAdapter`.
2. Register the class in `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/registry.py` and add the
...
[configuration](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/CONFIG.md)). Local runtimes (Ollama,
