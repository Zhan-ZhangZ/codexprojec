...
Source of truth: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/registry.py`, individual adapter files.
...
run on Cloudflare. See [Codex on Cloudflare Sandboxes](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/cloudflare/cloudflare-codex-sandbox.md)
...
`STRATEGY_MATRIX` (`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/_contract.py`):
...
next to `acp serve` in [interop/acp.md](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/interop/acp.md).
