...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/_contract.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/adapters/_contract.py).
...
unchanged. See [https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/artifacts.md](https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/docs/operations/artifacts.md) for the
...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/plugin_sdk.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/adapters/plugin_sdk.py).
...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/adapters/test_openai_agents_builtins.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/tests/unit/adapters/test_openai_agents_builtins.py):
...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/openai_agents_builtins.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/adapters/openai_agents_builtins.py).
