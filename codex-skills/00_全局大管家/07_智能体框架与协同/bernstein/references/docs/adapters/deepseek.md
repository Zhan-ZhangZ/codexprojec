...
adapter's `_MODEL_MAP` (see `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/ollama.py`).
...
- Source: `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/ollama.py` (the DeepSeek V4 entries
