...
[`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/src/bernstein/adapters/session_id.py`](https://github.com/sipyourdrink-ltd/bernstein/blob/main/src/bernstein/adapters/session_id.py)
