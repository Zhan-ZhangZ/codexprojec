...
| YAML contract | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/contract/contracts/computer_use.yaml` |
| Golden transcript | `https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/golden/computer_use_adapter.yaml` |
