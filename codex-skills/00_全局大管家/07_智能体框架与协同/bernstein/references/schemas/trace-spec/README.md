...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/unit/test_trust_record_conformance.py` validates every committed vector
...
`https://github.com/sipyourdrink-ltd/bernstein/blob/v3.19.0/tests/fixtures/trust-record-vectors/_build_trust_record_vectors.py`.) Result at
